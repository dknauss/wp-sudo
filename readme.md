...
**Non-interactive requests (WP-CLI, Cron, XML-RPC, Application Passwords, and GraphQL if installed):** Configurable per-surface policies with three modes: **Disabled**, **Limited** (default), and **Unrestricted**.
